 ...
 */
	public function add() {
		...
		if ($this->request->is('post')) {
			...
			$testimonial_count=$this->User->query("select testimonial  from notification where id = '1'");
			$num_testimonial=$testimonial_count[0]['notification']['testimonial']+1;
			//debug($testimonial_count[0]['notification']['testimonial']);
			//debug($num_testimonial);die;
			...
			if ($this->Testimonial->save($this->request->data)) {
				...
				$this->User->query("UPDATE `notification` SET testimonial=$num_testimonial where id = '1'");
	...
	public function admin_notification(){
		...
		if($this->request->is('ajax')){
			if(isset($this->request->data['testimonial'])){
				$testimonial=$this->request->data['testimonial'];
				$this->Testimonial->query("update notification  set  testimonial='{$testimonial}' where id = '1'");
				$testimonial_count=$this->Testimonial->query("select testimonial  from notification where id = '1'");
				$num_testimonial=$testimonial_count[0]['notification']['testimonial'];
			}else{
				$testimonial_count=$this->Testimonial->query("select testimonial  from notification where id = '1'");
				$num_testimonial=$testimonial_count[0]['notification']['testimonial'];
			}
		
			echo $num_testimonial;
		}
	}
