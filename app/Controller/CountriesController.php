	...
	public function admin_add() {
		if ($this->request->is('post')) {
			...
			if ($this->Country->save($this->request->data)) {
				...
				$this->Session->setFlash('The country could not be saved. Please, try again.','default',array('class'=>'error-message'));
			}
		}
	}
	...
	public function admin_edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->Country->save($this->request->data)) {
				...
				$this->Session->setFlash('The country could not be updated. Please, try again.','default',array('class'=>'error-message'));
			}
		} else {
			$options = array('conditions' => array('Country.' . $this->Country->primaryKey => $id));
 ...
 */
	public function admin_delete($id = null) {
		...
		if ($this->Country->delete()) {
			...
			$this->Session->setFlash('The country could not be deleted. Please, try again.','default',array('class'=>'error-message'));
		}
		return $this->redirect(array('action' => 'index'));
	}}
