		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<ul class="meta-job-detail">
					<li>
                    <?php
					echo $this->Html->link(__('Edit Profile'), array('controller'=>'users','action' => 'seeker_edit'),array('class'=>'btn btn-default btn-green btn-sm')); ?>
					<?php
					echo $this->Html->link(__('Change password'), array('controller'=>'users','action' => 'change_password'),array('class'=>'btn btn-default btn-green btn-sm')); ?> 
					
                    <?php if(empty($testimonial_existance)){
					echo $this->Html->link(__('Add Testimonial'), array('controller'=>'testimonials','action' => 'add'),array('class'=>'btn btn-default btn-green btn-sm'));
					}
					else{
						echo $this->Html->link(__('View Testimonial'), array('controller'=>'testimonials','action' => 'view'),array('class'=>'btn btn-default btn-green btn-sm'));
					}?> 					
					<?php
					echo $settings['PaypalSetting']['paypal_is_active']==1?$this->Html->link(__('Recharge Paypal'), array('controller'=>'payments','action' => 'paypal'),array('class'=>'btn btn-default btn-green btn-sm')):''; ?> 
					<?php
					echo $this->Html->link(__('Bank Deposit'), array('controller'=>'payments','action' => 'bank_deposit'),array('class'=>'btn btn-default btn-green btn-sm')); ?> 
					 <?php
					echo $settings['PaypalSetting']['esewa_is_active']==1?$this->Html->link(__('Esewa Deposit'), array('controller'=>'payments','action' => 'esewa_deposit'),array('class'=>'btn btn-default btn-green btn-sm')):''; ?> 
					<?php
					//echo $settings['PaypalSetting']['moco_is_active']==1?$this->Html->link(__('MoCo Payment'), array('controller'=>'payments','action' => 'moco_deposit'),array('class'=>'btn btn-default btn-green btn-sm')):''; ?> 
					<?php
					echo $this->Html->link(__('Deposit History'), array('controller'=>'service_seeker_deposits','action' => 'index'),array('class'=>'btn btn-default btn-green btn-sm')); ?>
                    
                    <?php
					echo $this->Html->link(__('Response(Enquire)'), array('controller'=>'seeker_provider_requests','action' => 'response_enquire'),array('class'=>'btn btn-default btn-green btn-sm')); ?>
                    <?php
					echo $this->Html->link(__('Response'), array('controller'=>'ServiceRequestRelays','action' => 'seeker_request'),array('class'=>'btn btn-default btn-green btn-sm')); ?>
					</li>
				</ul>
