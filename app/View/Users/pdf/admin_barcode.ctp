<table width="420" border="0" cellpadding="5" cellspacing="0" style="border: 5px solid #4e1111;">
    	...
    	<td colspan="2">
            <table border="0" cellpadding="2" cellspacing="0" style="font-size:20px;">
                ...
                <tr>
                    ...
                    <td align="left"><?php echo $this->Time->format('M d, Y',$userInfo['User']['issue_date']);?></td>
                </tr>
                
                <tr>
                    <td><i>Date of Expiry :</i></td>
                    <td align="left"><?php echo $this->Time->format('M d, Y',$userInfo['User']['expire_date']);?></td>
                </tr>
            </table>
        </td>
    </tr>
